...
export namespace ShapeTypeExtensions {
  export function hasZ(type: ShapeType): boolean {
    return (
  ...
  export function hasM(type: ShapeType): boolean {
    return (
  ...
  export function isPoint(type: ShapeType): boolean {
    return (
  ...
  export function isMultiPoint(type: ShapeType): boolean {
    return (
  ...
  export function isPolyline(type: ShapeType): boolean {
    return (
  ...
  export function isPolygon(type: ShapeType): boolean {
    return (
  ...
  export function dimension(type: ShapeType): number {
    const dim = hasZ(type) ? 3 : 2;
    return dim + measures(type);
  }

  export function measures(type: ShapeType): number {
    return hasM(type) ? 1 : 0;
  }
}
